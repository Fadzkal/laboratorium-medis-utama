...
const DB = (() => {
  ...
  const FASKES = {
    id: 1, nama: 'Laboratorium Medis Utama', jenis_faskes: 'Klinik Pratama',
    ...
    email: 'labutama@contoh.id', penanggung_jawab: 'dr. Fadzkal',
  ...
  const PEGAWAI = [
    { id: 'peg-1', nama: 'dr. Fadzkal', peran: 'dokter', no_sip: '446/SIP/2024/0091',
    ...
    { id: 'peg-4', nama: 'apt. Dewi Lestari', peran: 'apoteker', aktif: true,
      no_sip: '', kode_dokter_pcare: '', satusehat_practitioner_id: '' },
    { id: 'peg-k1', nama: 'Anisah Nur Adinah', peran: 'karyawan', aktif: true, email: 'anisah@labmedis.id' },
    { id: 'peg-k2', nama: 'Awit Priyanti', peran: 'karyawan', aktif: true, email: 'awit@labmedis.id' },
    { id: 'peg-k3', nama: 'Aziz Budi Laksono', peran: 'karyawan', aktif: true, email: 'aziz@labmedis.id' },
    { id: 'peg-k4', nama: 'Lilis Apriyanti', peran: 'karyawan', aktif: true, email: 'lilis@labmedis.id' },
    { id: 'peg-k5', nama: 'Minto Rahaju', peran: 'karyawan', aktif: true, email: 'minto@labmedis.id' },
    { id: 'peg-k6', nama: 'Nabila Nadhifatul Jannah', peran: 'karyawan', aktif: true, email: 'nabila@labmedis.id' },
    { id: 'peg-k7', nama: 'Nafis Salma Afiyah', peran: 'karyawan', aktif: true, email: 'nafis@labmedis.id' },
    { id: 'peg-k8', nama: 'Ratna Ruby Mutiarin', peran: 'karyawan', aktif: true, email: 'ratna@labmedis.id' },
    { id: 'peg-k9', nama: 'Retno Dwijayanti', peran: 'karyawan', aktif: true, email: 'retno@labmedis.id' },
    { id: 'peg-k10', nama: 'Salsa Billa Luthfi Ramadhany', peran: 'karyawan', aktif: true, email: 'salsa@labmedis.id' },
    { id: 'peg-k11', nama: 'Siti Aminatul Khasanah', peran: 'karyawan', aktif: true, email: 'siti.aminatul@labmedis.id' },
    { id: 'peg-k12', nama: 'Yana Jumhana', peran: 'karyawan', aktif: true, email: 'yana@labmedis.id' },
    { id: 'peg-k13', nama: 'Ma\'rifah Nurul Ilmiatun', peran: 'karyawan', aktif: true, email: 'marifah@labmedis.id' },
    { id: 'peg-k14', nama: 'Aisyah Nur Hidayah', peran: 'karyawan', aktif: true, email: 'aisyah@labmedis.id' }
  ];
  ...
  const PERAN_DEMO = {
    dokter:      { ...PEGAWAI[0], email: 'dokter@labutama.id', poli: POLI[0] },
    'dokter gigi': { ...PEGAWAI.find(p => p.jenis_dokter === 'GIGI'),
                     email: 'drg@labutama.id', poli: POLI[1] },
    perawat:     { ...PEGAWAI.find(p => p.peran === 'perawat'), email: 'perawat@labutama.id' },
    admin:       { ...PEGAWAI.find(p => p.peran === 'admin'), email: 'daftar@labutama.id' },
  ...
  let ANTREAN_SET = {
    konfigurasi: {
      ...
      teks_berjalan: 'Selamat datang di Laboratorium Medis Utama. Mohon menunggu nomor antrean Anda dipanggil.',
  ...
  let LAMPIRAN = [
    { id: 'lm-1', no_arsip: 'ARS-2026-0001', pasien_id: 'pas-1', kunjungan_id: 'kunj-7',
      ...
      tanggal_dokumen: hariIni, asal: 'Laboratorium Medis Utama', no_dokumen: 'F-0142',
  ...
  const SURAT = [
    { id: 'srt-1', jenis_kode: 'SKS', nomor_urut: 12,
      ...
      dokter_id: 'peg-1', ttd_nama: 'dr. Fadzkal',
  ...
  let KRONIS_TERAPI = [
    { id: 'kt-1', pasien_id: 'pas-1', aktif: true, tanggal_mulai: geser(-190), catatan: null,
      ...
      kontrol_besok: true, nama_poli: 'Poli Umum', nama_dokter: 'dr. Fadzkal',
