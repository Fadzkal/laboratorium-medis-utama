...
const DB = (() => {
  ...
  const PEGAWAI = [
    ...
    { id: 'peg-4', nama: 'apt. Dewi Lestari', peran: 'apoteker', aktif: true,
      no_sip: '', kode_dokter_pcare: '', satusehat_practitioner_id: '' },
    { id: 'peg-k1', nama: 'Anisah Nur Adinah', peran: 'karyawan', aktif: true, email: 'anisah@labutama.id' },
    { id: 'peg-k2', nama: 'Awit Priyanti', peran: 'karyawan', aktif: true, email: 'awit@labutama.id' },
    { id: 'peg-k3', nama: 'Aziz Budi Laksono', peran: 'karyawan', aktif: true, email: 'aziz@labutama.id' },
    { id: 'peg-k4', nama: 'Lilis Apriyanti', peran: 'karyawan', aktif: true, email: 'lilis@labutama.id' },
    { id: 'peg-k5', nama: 'Minto Rahaju', peran: 'karyawan', aktif: true, email: 'minto@labutama.id' },
    { id: 'peg-k6', nama: 'Nabila Nadhifatul Jannah', peran: 'karyawan', aktif: true, email: 'nabila@labutama.id' },
    { id: 'peg-k7', nama: 'Nafis Salma Afiyah', peran: 'karyawan', aktif: true, email: 'nafis@labutama.id' },
    { id: 'peg-k8', nama: 'Ratna Ruby Mutiarin', peran: 'karyawan', aktif: true, email: 'ratna@labutama.id' },
    { id: 'peg-k9', nama: 'Retno Dwijayanti', peran: 'karyawan', aktif: true, email: 'retno@labutama.id' },
    { id: 'peg-k10', nama: 'Salsa Billa Luthfi Ramadhany', peran: 'karyawan', aktif: true, email: 'salsa@labutama.id' },
    { id: 'peg-k11', nama: 'Siti Aminatul Khasanah', peran: 'karyawan', aktif: true, email: 'siti.aminatul@labutama.id' },
    { id: 'peg-k12', nama: 'Yana Jumhana', peran: 'karyawan', aktif: true, email: 'yana@labutama.id' },
    { id: 'peg-k13', nama: 'Ma\'rifah Nurul Ilmiatun', peran: 'karyawan', aktif: true, email: 'marifah@labutama.id' },
    { id: 'peg-k14', nama: 'Aisyah Nur Hidayah', peran: 'karyawan', aktif: true, email: 'aisyah@labutama.id' }
  ];
