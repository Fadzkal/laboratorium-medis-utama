...
/* ------------------------------------------------------------------ */
const KTX = {
  faskes: { nama: 'Laboratorium Medis Utama', kabupaten: 'Kota Manado' },
  pasien: {
  ...
  dokter: { id: 'peg-1', nama: 'dr. Fadzkal', no_sip: '446/SIP/2024/0091' },
...
/* ------------------------------------------------------------------ */
{
  ...
  /* Bawaannya diagnosa TIDAK ikut tercetak. Ini keputusan yang diminta
     Fadzkal; kalau suatu saat berubah, ujinya yang harus diubah lebih
...
/* ------------------------------------------------------------------ */
{
  ...
  cek('halaman cetak memuat nama & SIP dokter',
      html.includes('dr. Fadzkal') && html.includes('446/SIP/2024/0091'));
