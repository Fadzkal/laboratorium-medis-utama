-- =====================================================================
--  MIGRASI: Samakan Persis Data Paket Skylab Asli
--  Tanggal : 2026-09-19
--  Cara    : Jalankan di Supabase SQL Editor (satu kali saja)
-- =====================================================================

-- 1. Bersihkan paket dan keranjang lama agar tidak bentrok
delete from kunjungan_lab_item;
delete from ref_lab_paket_item;
delete from ref_lab_paket;

-- 2. Upsert ref_lab sesuai data Skylab yang terlihat
...
-- 4. Insert Item Paket
insert into ref_lab_paket_item (paket_id, lab_id, urutan, harga)
select p.id, l.id, k.u, 0 from (select id from ref_lab_paket where kode='1908186') p,
(values ('H0102',1),('K0301',2),('K0304',3),('K0332',4),('K0328',5)) k(kode,u)
join ref_lab l on l.kode = k.kode;

insert into ref_lab_paket_item (paket_id, lab_id, urutan, harga)
select p.id, l.id, k.u, 0 from (select id from ref_lab_paket where kode='1802180') p,
(values ('10238',1),('10237',2),('10235',3),('10236',4),('10239',5),('10240',6)) k(kode,u)
join ref_lab l on l.kode = k.kode;

insert into ref_lab_paket_item (paket_id, lab_id, urutan, harga)
select p.id, l.id, k.u, 0 from (select id from ref_lab_paket where kode='2603187') p,
(values ('K0326',1),('K0327',2)) k(kode,u)
join ref_lab l on l.kode = k.kode;

insert into ref_lab_paket_item (paket_id, lab_id, urutan, harga)
select p.id, l.id, k.u, 0 from (select id from ref_lab_paket where kode='2603188') p,
(values ('K0301',1),('K0302',2),('K0303',3),('K0304',4),('K0329',5),('K0331',6),('U0106',7)) k(kode,u)
join ref_lab l on l.kode = k.kode;

insert into ref_lab_paket_item (paket_id, lab_id, urutan, harga)
select p.id, l.id, k.u, 0 from (select id from ref_lab_paket where kode='2603190') p,
(values ('K0301',1),('K0303',2),('K0302',3),('K0304',4),('K0329',5),('K0331',6),('U0106',7),('K0326',8),('K0335',9),('K0327',10)) k(kode,u)
join ref_lab l on l.kode = k.kode;

insert into ref_lab_paket_item (paket_id, lab_id, urutan, harga)
select p.id, l.id, k.u, 0 from (select id from ref_lab_paket where kode='2603189') p,
(values ('K0301',1),('K0303',2),('K0302',3),('K0304',4),('K0329',5),('K0331',6),('U0106',7),('K0326',8),('K0335',9)) k(kode,u)
join ref_lab l on l.kode = k.kode;

insert into ref_lab_paket_item (paket_id, lab_id, urutan, harga)
select p.id, l.id, k.u, 0 from (select id from ref_lab_paket where kode='2603191') p,
(values ('K0301',1),('K0303',2),('K0302',3),('K0304',4),('K0329',5),('K0331',6),('U0106',7),('K0328',8),('K0335',9)) k(kode,u)
join ref_lab l on l.kode = k.kode;

insert into ref_lab_paket_item (paket_id, lab_id, urutan, harga)
select p.id, l.id, k.u, 0 from (select id from ref_lab_paket where kode='1908184') p,
